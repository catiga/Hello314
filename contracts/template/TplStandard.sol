...
abstract contract ERC314 is IEERC314{
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_, uint256 totalSupply_, uint256 maxWallet_) {
        _name = name_;
        _symbol = symbol_;
...
contract TplStandard is ERC314 {
    ...
    constructor(address _owner_, string memory name_, string memory symbol_, 
        uint256 _totalSupply, uint256 _maxWallet_) ERC314(name_, symbol_, _totalSupply, _maxWallet_) {
